...
<body>
    <div class="main">
        ...
        <div class="text-left" id="commits">
            ...
            if (isset($_POST['submit'])) {
                ...
                //save all input of the form in a txt file for future reference every time the form is submitted save the file name as $user
                $myfile = fopen("$user.txt", "w") or die("Unable to open file!");
                $txt = "Repository Name: $reponame\n";
                fwrite($myfile, $txt);
                $txt = "Repository Owner: $repoowner\n";
                fwrite($myfile, $txt);
                $txt = "Access Token: $token\n";
                fwrite($myfile, $txt);
    ...
    <script>
        ...
        function myFunction() {
            // Get the text field
            var copyText = document.getElementById("commits").text();
